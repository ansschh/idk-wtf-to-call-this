    ...
    <div className="min-h-screen relative bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-1/4 right-1/3 w-1 h-1 bg-indigo-300 rounded-full opacity-20" />
        </div>
      </div>
      ...
      <div className="relative w-full max-w-md px-4">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Join Kepler today</h1>
          <p className="text-gray-600">
            Start your scientific writing journey with AI assistance
          </p>
        </div>

        {/* Clerk SignUp with enhanced styling */}
        <SignUp
          routing="path"
          path="/sign-up"
          signInUrl="/sign-in"
          ...
          appearance={{
            elements: {
              ...
              formFieldWarningText: "text-xs text-yellow-600 mt-1",
              ...
              formResendCodeLink: "text-blue-600 hover:text-blue-700 text-sm font-medium transition-colors duration-200",
              otpCodeFieldInput: "bg-white/80 backdrop-blur-sm border border-gray-200 text-gray-900 rounded-xl w-12 h-12 text-center text-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200",
            }
          }}
        />
